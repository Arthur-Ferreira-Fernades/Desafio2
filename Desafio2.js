        ...
        switch (opcao) {
                        ...
                        rl.question('Digite sua senha: ', (senha) => {
                            rl.question('Digite o número de telefone: ', (telefoneNumero) => {
                                rl.question('Digite o DDD do telefone: ', async (telefoneDDD) => {
                                    await realizarSignUp(nome, email, senha, telefoneNumero, telefoneDDD);
                                    // A lógica de mostrar as opções agora é chamada dentro de realizarSignUp
                                });
                            });
                        });
                    });
            ...
            case '3':
                app.get('/user', authenticateToken, async (req, res) => {
                    ...
                    try {
                        // Consulta as informações do usuário usando o ID extraído do token
